...
ActiveRecord::Schema.define(version: 2021_07_28_001713) do
  ...
  create_table "tried_strategy_references", force: :cascade do |t|
    t.bigint "diary_id"
    t.bigint "strategy_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["diary_id"], name: "index_tried_strategy_references_on_diary_id"
    t.index ["strategy_id"], name: "index_tried_strategy_references_on_strategy_id"
  end

  add_foreign_key "tried_strategy_references", "diaries"
  add_foreign_key "tried_strategy_references", "strategies"
end
